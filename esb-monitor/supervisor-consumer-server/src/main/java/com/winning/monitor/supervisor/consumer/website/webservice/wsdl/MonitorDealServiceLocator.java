...
public class MonitorDealServiceLocator extends org.apache.axis.client.Service implements MonitorDealService {
    ...
    public MonitorDeal_PortType getMonitorDeal(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.winning.monitor.supervisor.consumer.website.webservice.wsdl.MonitorDealSoapBindingStub _stub = new com.winning.monitor.supervisor.consumer.website.webservice.wsdl.MonitorDealSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (MonitorDeal_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.winning.monitor.supervisor.consumer.website.webservice.wsdl.MonitorDealSoapBindingStub _stub = new com.winning.monitor.supervisor.consumer.website.webservice.wsdl.MonitorDealSoapBindingStub(new java.net.URL(MonitorDeal_address), this);
                _stub.setPortName(getMonitorDealWSDDServiceName());
                return _stub;
            }
        }
