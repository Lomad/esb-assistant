...
<div class="row" style="margin: 0px -20px 0px -20px;">
    <#--<div class="col bgf" style="line-height: 30px;margin: 15px">
        <span style="margin-left: 15px">
            ${clientAppName}/ 耗时占比 ( 消费方: ${clientAppName}>
            <#if type = "指定小时">
            ${time}
            <#else>
            ${type}
            </#if>>${serverAppName}>${transactionTypeName}>
            <#if serverIpAddress = "">
                所有主机
            <#else>
            ${serverIpAddress}
        ...
        <div class="x_panel">
            ...
            <div class="x_title">
                <div class="col-md-9" style="padding: 0px">
                    <span>耗时占比-消费方:${clientAppName}>
                    <#if type = "指定小时">${time}<#else>${type}</#if>>${serverAppName}>${transactionTypeName}>
            ...
            <div class="x_content">
                <div class="col-md-12" style="min-height: 200px;padding: 0px" id="echart"></div>
            </div>
        </div>
    </div>
...
<#--<div class="row bgf bb1" style="margin-top:-25px;">
...
<@list.foot echart=true>
    <#assign contextPath = request.contextPath>
<script src="${contextPath}/project-assets/js/monitor/clientsteprealtime.js" type="text/javascript"></script>
</@list.foot>