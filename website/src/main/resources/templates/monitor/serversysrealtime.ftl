        ...
        <div class="x_panel">
            ...
            <div class="x_title">
                <div class="col-md-10" style="padding: 0px">
                    <span style="margin-left: 15px">${serverAppName} > ${transactionTypeName} >
                    <#if type = "指定小时">${time}<#else>${type}</#if>
                    </span>
...
<@list.foot>
    <#assign contextPath=request.contextPath>
<script src="${contextPath}/project-assets/js/monitor/serversysrealtime.js" type="text/javascript"></script>
</@list.foot>