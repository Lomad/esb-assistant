...
<div class="row" style="margin: 0px -20px 0px -20px;">
    <#--<div class="col bgf" style="line-height: 30px;margin: 15px">
        <span style="margin-left: 15px">
            ...
            ${value}>${clientAppName}>${transactionTypeName}>
            <#if serverIpAddress = "">
                所有主机
            <#else>
            ${serverIpAddress}
        ...
        <div class="x_panel">
            ...
            <div class="x_title">
                <div class="col-md-9" style="padding: 0px">
                    <span>耗时占比-提供方 : ${serverAppName}>${value}>${clientAppName}>${transactionTypeName}>
...
<@list.foot echart=true>
    <#assign contextPath=request.contextPath>
<script src="${contextPath}/project-assets/js/monitor/serverstephistory.js" type="text/javascript"></script>
</@list.foot>