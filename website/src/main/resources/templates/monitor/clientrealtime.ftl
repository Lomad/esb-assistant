...
<div class="row" style="margin: 0px -20px 0px -20px;">
    <div class="col-md-3" style="padding-right: 0px;margin-top: 15px;height: 600px">
        <div id="treeDiv" class="row common-box font-size-14" style="margin-top: 0px;height: inherit">
        ...
        <div id="relationChartsDiv" class="col-md-12 col-sm-12 bgf" style="padding-right: 0px;padding-left: 0px">
            <div class="x_panel">
                <div class="x_title_without-header">
                    <span class="panel-title" style="font-size: 14px;color: #444">消费方监控运行情况</span>
                ...
                <div class="x_content">
                    <table id="fTable" class="mytable">
                        ...
                        <th class="numeric sorting"  data-id="avg">平均耗时</th>-->
                            ...
                            <#--<th class="numeric">99%<span class="glyphicon glyphicon-info-sign" data-toggle="tooltip"  data-placement="right" title="置信度99%：对应值为总体真值，表示99%的样本置信区间覆盖此真值"></span></th>
                            <th class="numeric">95%<span class="glyphicon glyphicon-info-sign" data-toggle="tooltip"  data-placement="right" title="置信度95%：对应值为总体真值，表示95%的样本置信区间覆盖此真值"></span></th>-->
...
<@list.foot tree=true echart=true>
    <#assign contextPath=request.contextPath>
<script src="${contextPath}/project-assets/js/monitor/clientrealtime.js" type="text/javascript"></script>
</@list.foot>