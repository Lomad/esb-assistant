...
<div class="row" style="margin: 0px -20px 0px -20px;">
    ...
    <div class="col-md-9 margin-top-15">
        <div class="col-md-12 col-sm-12 bgf" style="padding-right: 0px;padding-left: 0px" id="relationChartsDiv">
            <div class="x_panel">
...
<script src="${contextPath}/project-assets/js/monitor/clienthistory.js" type="text/javascript"></script>
</@list.foot>